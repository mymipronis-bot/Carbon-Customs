...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-slide img { width: 100%; height: 100%; object-fit: cover; filter: brightness(0.28) saturate(0.5); }
  .hero-bg { position: absolute; inset: 0; z-index: 2; background: linear-gradient(180deg, rgba(8,8,8,0.2) 0%, rgba(8,8,8,0.7) 55%, #080808 100%), linear-gradient(90deg, rgba(8,8,8,0.5) 0%, transparent 50%, rgba(8,8,8,0.5) 100%); }
    ...
    <>
      ...
      <footer className="footer">
        ...
        <div className="footer-bottom">
          <p className="footer-copy">© 2026 Carbon Customs. All rights reserved.</p>
