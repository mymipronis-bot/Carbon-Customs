...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-bg {
    ...
    background:
      radial-gradient(ellipse 50% 60% at 80% 30%, rgba(0,102,255,0.08) 0%, transparent 65%),
      radial-gradient(ellipse 30% 40% at 20% 80%, rgba(255,59,59,0.04) 0%, transparent 60%),
      linear-gradient(180deg, transparent 30%, var(--black) 100%);
  }
  .hero-pattern {
    position: absolute; inset: 0; opacity: 0.02;
    background-image: repeating-linear-gradient(
      45deg, var(--blue) 0, var(--blue) 1px, transparent 0, transparent 50%
    );
  ...
  .hero-sub {
    ...
    line-height: 1.85; margin-top: 1.8rem; position: relative;
  }
  .hero-actions {
...
export default function App() {
  ...
  return (
    <>
      ...
      {/* NAV */}
      <nav className="nav">
        <a href="#" className="nav-logo">CARBON<span>CUSTOMS</span></a>
