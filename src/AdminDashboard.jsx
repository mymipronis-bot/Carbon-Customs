...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .login-logo {
    ...
    font-size: 1.6rem; letter-spacing: 0.1em; text-transform: uppercase;
  ...
  .login-error {
    background: rgba(255,59,59,0.1); border: 1px solid var(--red);
    color: var(--red); font-size: 0.78rem; padding: 0.7rem 1rem;
  ...
  .field-input {
    background: #0a0a0a; color: var(--white); border: 1px solid var(--border);
  ...
  .login-btn {
    ...
    cursor: pointer; border-radius: var(--radius); margin-top: 0.5rem;
  ...
  .admin-header {
    ...
    padding: 1rem 5vw; display: flex; align-items: center; justify-content: space-between;
  }
  .admin-logo {
    font-family: 'Barlow Condensed', sans-serif; font-weight: 800;
  ...
  .logout-btn {
    ...
    padding: 0.45rem 1rem; font-family: 'Space Mono', monospace; font-size: 0.62rem;
  ...
  .admin-title {
    font-family: 'Barlow Condensed', sans-serif; font-weight: 800;
    font-size: 2rem; letter-spacing: -0.01em; text-transform: uppercase;
  }
  .admin-count {
  ...
  .add-btn {
    ...
    padding: 0.7rem 1.3rem; font-family: 'Space Mono', monospace;
    font-size: 0.7rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase;
    cursor: pointer; border-radius: var(--radius); transition: background 0.2s;
  }
  ...
  .row-price {
    font-family: 'Barlow Condensed', sans-serif; font-weight: 700;
    color: var(--red); font-size: 1rem; white-space: nowrap;
  }
  ...
  .modal-form {
    background: var(--card); border: 1px solid var(--border);
    max-width: 460px; width: 100%; border-radius: var(--radius);
    margin: 2rem 0;
  }
  .modal-form-header {
  ...
  .specs-remove {
    ...
    width: 38px; border-radius: var(--radius); cursor: pointer; flex-shrink: 0;
  }
  .specs-add {
    background: transparent; border: 1px dashed var(--border); color: var(--muted);
    padding: 0.5rem; font-family: 'Space Mono', monospace; font-size: 0.65rem;
  ...
  .btn-cancel {
    ...
    padding: 0.8rem; font-family: 'Space Mono', monospace; font-size: 0.7rem;
    letter-spacing: 0.1em; text-transform: uppercase; cursor: pointer; border-radius: var(--radius);
  }
  .btn-save {
    flex: 2; background: var(--blue); border: none; color: #fff;
    padding: 0.8rem; font-family: 'Space Mono', monospace; font-size: 0.7rem;
  ...
  .field-select {
    background: #0a0a0a; color: var(--white); border: 1px solid var(--border);
    border-radius: var(--radius); padding: 0.8rem 1rem;
    font-family: 'Inter', sans-serif; font-size: 0.85rem; width: 100%;
  }
  ...
  .image-preview {
    ...
    margin-bottom: 0.6rem; background: #0a0a0a;
  }
  .upload-btn {
    display: flex; align-items: center; justify-content: center;
    background: transparent; border: 1px dashed var(--blue); color: var(--blue);
    padding: 0.7rem; font-family: 'Space Mono', monospace; font-size: 0.68rem;
    letter-spacing: 0.1em; text-transform: uppercase; cursor: pointer;
    border-radius: var(--radius); transition: background 0.2s;
  }
  .upload-btn:hover { background: rgba(0,102,255,0.08); }
  .upload-error-text {
    color: var(--red); font-size: 0.72rem; margin-top: 0.4rem;
  }

  .toast {
    position: fixed; bottom: 1.5rem; left: 50%; transform: translateX(-50%);
    background: var(--green); color: #fff; padding: 0.8rem 1.5rem;
    border-radius: var(--radius); font-size: 0.82rem; z-index: 300;
    font-family: 'Inter', sans-serif; box-shadow: 0 8px 30px rgba(0,0,0,0.4);
  }
            ...
            {form.specs.map((s, i) => (
              <div className="specs-input-row" key={i}>
                <input
                  ...
                  placeholder="e.g. 3K Carbon Fiber Weave"
                />
      ...
      <div className="admin-wrap">
        ...
        <main className="admin-body">
          <div className="admin-toolbar">
            ...
            <button className="add-btn" onClick={() => { setEditingProduct(null); setFormOpen(true); }}>
              + Add Product
            </button>
          </div>
